<template>
  <view class="vip-container">
    ...
    <view class="vip-list">
      <text class="header">VIP会员四大权益</text>
      <view class="vip-list-box">
        <view
          class="vip-list-item"
          v-for="(_item,index) in vipConfig"
          :key="index"
        >
          <image
            class="vip-img"
    ...
    <view class="pay-way-box">
      ...
      <view class="pay-way-list">
        ...
        >
          ...
          <view>
            <text class="RMB">¥</text>
            <text class="money">{{_item.pay}}</text>
          </view>
        </view>
      </view>
    </view>

    <view class="vip-agreement-box">
      <view class="agreement-box">
        <text class="info1">开通会员表示您同意</text>
        <text class="info2"> 会员服务协议</text>
      </view>
      <button style="background:url(/static/images/order_btn.png);background-size:100%">立即开通</button>
    </view>
  </view>
</template>
    ...
    .pay-way-item {
      ...
      &.active {
        ...
        .RMB {
          font-size: 28upx;
          font-family: SFNSDisplay;
          color: rgba(255, 117, 71, 1);
          line-height: 33upx;
        }
        .money {
          font-size: 58upx;
          font-family: SFNSDisplay;
          color: rgba(255, 71, 27, 1);
          line-height: 68upx;
          background: linear-gradient(
              154deg,
              rgba(255, 169, 122, 1) 0%,
              rgba(255, 111, 66, 1) 46%,
              rgba(255, 43, 0, 1) 100%
            ),
            linear-gradient(
              154deg,
